...
Architecture: next-frame predictor (replaces autoencoder).
  Input:  frames 0..T-2
  Target: frames 1..T-1
...
if __name__ == '__main__':
    ...
    # CosineAnnealingLR — smooth decay, never kills the lr prematurely
    ...
    for epoch in range(CFG['epochs']):
        ...
        scheduler.step()   # cosine — no loss argument needed
